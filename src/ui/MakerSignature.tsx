...
/*
 * 18px on a 24-unit grid.
 *
 * The GitHub and Instagram paths are the official marks, taken verbatim from
 * Simple Icons (CC0), because a trademark traced by hand is a trademark drawn
 * wrong. They are pasted rather than imported: four glyphs do not justify an
 * icon dependency against the bundle budget.
 *
 * LinkedIn is not in Simple Icons - it was withdrawn at LinkedIn's request -
 * so that one mark is still a rendition rather than the official artwork.
 *
 * The globe is drawn here on purpose. It belongs to nobody, and it is a stroke
 * figure so it reads as an outline beside three filled marks.
 */
